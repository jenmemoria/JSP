...
<ul>
	...
	<li>Object 타읩으로 정의되어 있어서, 자바의 모든 객체를 사용할 수 있다.</li>
...
<%
	...
	out.print("<p>ob3 : " + ob3 + "</p>"); // test3를 꺼내서 저장해서 값을 가져온거
	...
	out.print("<p>test3 : " + request.getAttribute("test3") + "</p>"); // test3을 직접 꺼내 들고 온 것.
...
<table border="1" cellpadding="10" cellspacing="0">
	...
	<tr>
		<td>session</td>
		<!-- 자기 것만 꺼낼 수 있다. -->
		<td>현재 사용자가 요청하는 모든 페이지에 대해 공유할 수 있는 attribute 저장소 (마치 로그인처럼)</td>
	</tr>
	<tr>
		<td>application</td>
