...
<h3>application/x-www-form-urlencoded (method: POST일 때 기본 전송 형식)</h3>
...
<ul>
	...
	<li>multipart/form-data는 JSP 내장객체 request로 파일을 추출할 수 없다.</li>
</ul>

<fieldset>
	<form method="POST" enctype="multipart/form-data" action="ex01-action.jsp">
		<p><input type="text" name="test1" value="유리.png"></p>
		<p><input type="file" name="profileImg" value="유리.png"></p>
