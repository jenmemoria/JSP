...
public class McdonaldDAO {
	...
	public McdonaldDTO selectOne(int idx) { // 원래 파라미터의 자료형은 스트링 맞지만, EL 태그에서는 바로 숫자로 변하기 때문에 이렇게 써도 된댜
	...
	// 추가 (insert into mcdonald (category, name, price, imgPath, memo) values (?, ?, ?, ?, ?)
