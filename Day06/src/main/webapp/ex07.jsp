...
<ul>
	...
	<li>JSTL Sql : JSP에서 SQL문을 이용하기 DB와 상호작용하기 위한 태그</li>
...
<ol>
	...
	<li>action 태그는 기본 JSP 문법을 확장하여 여러 태그를 제공하지만, 부족한점이 있었다.</li>
	<li>여러 개발자들이 자신만의 태그를 생성하여 사용하기 시작했따 (Tag Library)</li>
	...
	<li>JSTL을 사용하기 위해서 상단에 taglib 지시자를 이용하여 선언해야 쓸수있다.</li>
</ol>
</body>
</html>