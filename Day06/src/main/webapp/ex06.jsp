...
<h3>expression language</h3> <!-- html에서 글자를 출력하는 용도로 -->
<h3>기존 표현식에서 attribute 및 parameter 값을 출력할 때 코드가 긴 점을 개선한 형태</h3>

<fieldset>
	<legend>attribute</legend>
	<p>내장객체에 저장된 attribute의 이름을 저장하면 값을 출력한다.</p>
	...
	<p>Map 형태의 객체는 [''] 안에 key 이름을 넣어서 value를 출력한다.</p>
	...
	<fieldset>
		<legend>Map</legend>
		<p>표현식 : <%=ob1.getName() %>, <%=((HashMap<String, String>)pageContext.getAttribute("map")).get("banana") %></p>
		<p>EL Tag : ${map.apple }, ${map['banana'] }</p> <!-- 여기서는 하나의 따옴표 -->
	</fieldset>
	<br>
